...
import { CajeroAutomatico } from "../typechain-types";
...
describe("Cajero Automatico", function () {
  async function deployFixture() {
    ...
    const CajeroAutomatico = await ethers.getContractFactory("EjercicioTres");
  ...
  describe("Retiro", function () {
    var cajeroAutomatico: CajeroAutomatico, otherAccounts: any[];
  ...
  describe("Pausado", function () {
    ...
    it("El admin cambia a true 'pausado'", async function () {
      ...
      await setBalance(admin, ethers.BigNumber.from("100000000000000000000"));
