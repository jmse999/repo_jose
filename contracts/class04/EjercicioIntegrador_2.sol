...
contract EjercicioDos {
    ...
    modifier soloListaBlanca(){
        require(listaBlanca[msg.sender],"No eres usuario");
        _;
     }
    ...
    // modificador de soloListaBlanca ids: 1.1.0
    ...
    modifier soloEnTiempo(){
        require(block.timestamp <= tiempoLimite,"Estas fuera de tiempo");
        _;
    }
    ...
    bool public pausado;
    modifier pausa(){
        require(!pausado,"Esta pausado");  // pausado = false
        _;
    }
